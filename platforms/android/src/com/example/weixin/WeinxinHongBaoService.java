 ...
 */
@SuppressLint("NewApi")
public class WeinxinHongBaoService extends AccessibilityService{
	...
	/** 点开红包资源id */ 
	private static final String WEINXIN_HONGBAO_ID_OPEN = "com.tencent.mm:id/ba_"; //随微信版本会变
	

	private static int lastHongbaoNum =0; //初始化没有红包
	private static int speHongbaoNum =3; //特殊红包个数，如果超过这个值，则依然领取
